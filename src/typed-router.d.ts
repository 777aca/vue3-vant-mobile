...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'ApplistDetail': RouteRecordInfo<'ApplistDetail', '/applist/detail', Record<never, never>, Record<never, never>>,
    ...
    'ListDetail': RouteRecordInfo<'ListDetail', '/list/detail', Record<never, never>, Record<never, never>>,
